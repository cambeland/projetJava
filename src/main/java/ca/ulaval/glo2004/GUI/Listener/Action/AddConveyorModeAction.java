...
public class AddConveyorModeAction extends ModeAction{
    public AddConveyorModeAction(AppMasterFrame masterFrame, ToolBarPanel toolBarPanel){
    ...
    public void actionPerformed(ActionEvent e){
        doDefaultAction(e);
        CursorStateModifier.addConveyorCursorModifier(masterFrame);
        masterFrame.setMode(ApplicationMode.ADD_CONVEYOR);
