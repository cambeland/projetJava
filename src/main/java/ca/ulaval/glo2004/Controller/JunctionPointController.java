...
import ca.ulaval.glo2004.Domain.JunctionPoint;

public class JunctionPointController extends JunctionPoint implements Drawable, Movable, Serializable{
    protected boolean selected;
    protected Ellipse2D e;

    public JunctionPointController(String name, int posX, int posY, int radius){
        super(posX, posY);
        this.radius = radius;
    ...
    public JunctionPointController(String name, int posX, int posY){
